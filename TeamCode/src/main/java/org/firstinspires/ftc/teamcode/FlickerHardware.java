...
public class FlickerHardware
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        flickerMotor   = hwMap.dcMotor.get("flicker");
        flickerMotor.setDirection(DcMotor.Direction.REVERSE); // Set to REVERSE if using AndyMark motors
